...
export const graphQLClient = new GraphQLClient(`https://graphql.contentful.com/content/v1/spaces/${process.env.NEXT_PUBLIC_CONTENTFUL_SPACE}`, {
  headers: {
...
export const faireRequeteGql = (maRequete, lesVariables) => graphQLClient.request(maRequete , lesVariables)
